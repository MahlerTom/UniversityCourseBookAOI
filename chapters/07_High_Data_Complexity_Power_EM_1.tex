...
\section{Research Highlights}
    ...
    This paper examines specific methods for analyzing power consumption measurements to find secret keys from tamper resistant devices.
    ...
    \subsubsection{ Successfully Attacking Masked AES}
    Hardware Implementations

    
    Authors: Stefan Mangard, Norbert Pramstaller, and Elisabeth Oswald

    Published year: 2005

    Summary:

    This article presents an attack on masked AES Hardware implementations.
    ...
    \subsubsection{ Hardware Countermeasures against DPA – A Statistical Analysis of Their Effectiveness}
    ...
    \subsubsection{An AES Smart Card Implementation Resistant
    to Power Analysis Attacks}
    
    Authors: Christoph Herbst, Elisabeth Oswald, and Stefan Mangard

    Published year: 2006

    Summary:

    This article presents a countermeasure to Power Analysis attack on AES.
