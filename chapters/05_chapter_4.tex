...
%update: i added a box, maybe we should move it to ohms law section and reference it if needed?
...
% NOTE:and caption of the following pic and add ref
\begin{figure}[h]
    \centering
...
% TODO: the diagram doesnt seem like in the docs , the open cicuit isnt open
\begin{figure}[h]
    \centering
...
%NOTE: didnt quite understand "it will have no influence on it".
...
\pagebreak
%NOTE: we can also start th new section from another page if we want but there will be large unused space
...
% an icon of Ampermeter symbol ("A" inside a circle) - like here: https://thenounproject.com/term/ampermeter/96074/
% TODO: maybe also a good photo of such device
...
\end{figure}
%NOTE: maybe change "by ohm's law" -> "using ohm's law"
...
%NOTE: there may be a more latexy way of doing this
\newline
...
% TODO: Fix location and caption of the following pic and add ref
\begin{figure}[h]
    \centering
...
% TODO: Fix caption of the following pic and add ref
\begin{figure}
    \centering
...
%NOTE: made a table instead of the itemization
\begin{table}
    \centering
...
%NOTE: i think i have added all three to do's in here but there is a need to verify it
%TODO: fix the caption
\begin{figure}[h]
    \centering
    \input{tikz-images/Not_Gate.tikz}
...
\end{displaymath}
%NOTE: changed "We are realy don't care" to "we dont care"
...
\end{figure}
%NOTE: changed "that you can read more about" to "where you can read more about"
%NOTE: "Very localize" sounds wrong to me  but i cant think currently of a propper replacement 
